        ...
        <>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50">
            <div className="bg-white p-2 rounded-lg shadow-lg flex flex-col justify-between text-center w-full md:max-w-lg lg:max-w-xl md:h-42 md:w-42 lg:h-68 lg:w-68">
              ...
              <h4 className="text-2xl font-semibold mb-4">Alarm is ringing at <span className="digital7-font text-violet-600">{activeAlarm.alarmTime}</span></h4>
              <div className="flex justify-around mb-4">
                <button
                  onClick={nextSnoozeDisplay}
                  className="px-4 py-2 bg-violet-600 text-white font-bold rounded hover:bg-violet-700 hover:cursor-pointer"
                >
                  Snooze
                </button>
                <button
